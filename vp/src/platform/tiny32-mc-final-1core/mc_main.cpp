...
public:
	...
	addr_t sorter_start_addr = 0x73000000;
 	addr_t sorter_size = 0x01000000;
 	addr_t sorter_end_addr = sorter_start_addr + sorter_size - 1;
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[3] = new PortMapping(opt.sorter_start_addr, opt.sorter_end_addr);
	bus.ports[4] = new PortMapping(opt.dma_start_addr, opt.dma_end_addr);	
	...
	bus.isocks[3].bind(sorter.tsock);
	bus.isocks[4].bind(dma.tsock);
